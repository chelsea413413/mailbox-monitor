"""heilongjiang province crawler.

Site: http://sthj.hlj.gov.cn/sthj/ldxx/public_wycx.shtml
...
class HeilongjiangCrawler(PlaywrightCrawler):
    """heilongjiang province environment department mailbox crawler."""

    list_container = "ul.wycxlist li, table tr, .list li"
    list_title_sel = "a"
    list_url_sel = "a"
    list_url_attr = "href"
    ...
    pw_wait_selector = "ul.wycxlist, table"
