"""hubei province crawler.

Site: http://sthjt.hubei.gov.cn/hdjl/zxjygk/
...
class HubeiCrawler(PlaywrightCrawler):
    """hubei province environment department mailbox crawler."""

    list_container = "table tr, .jact_main tr, ul.list li"
    list_title_sel = "a"
    list_url_sel = "a"
    list_url_attr = "href"
    ...
    pw_wait_selector = "table, .jact_main"
