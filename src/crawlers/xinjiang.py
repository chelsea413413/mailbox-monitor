"""xinjiang province crawler.

Site: https://sthjt.xinjiang.gov.cn/xjepd/zmhdtzxx/hd_mailbox.shtml
...
class XinjiangCrawler(PlaywrightCrawler):
    """Xinjiang province environment department mailbox crawler."""
