"""fujian province crawler.

Site: https://sthjt.fujian.gov.cn/gzcy/tzxx/
...
class FujianCrawler(PlaywrightCrawler):
    """Fujian province environment department mailbox crawler."""
