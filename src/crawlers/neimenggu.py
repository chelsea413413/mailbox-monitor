"""neimenggu province crawler.

Site: https://sthjt.nmg.gov.cn/hdjl/zsk_8258/
...
class NeimengguCrawler(PlaywrightCrawler):
    """Neimenggu province environment department mailbox crawler."""
