"""guizhou province crawler.

Site: https://sthj.guizhou.gov.cn/hdjl/
...
class GuizhouCrawler(PlaywrightCrawler):
    """guizhou province environment department mailbox crawler."""

    list_container = ".ldxxcon li, .ind_hdjl li, table tr, ul.list li"
    list_title_sel = "a"
    list_url_sel = "a"
    list_url_attr = "href"
    ...
    pw_wait_selector = ".ldxxcon, .ind_hdjl, table"
